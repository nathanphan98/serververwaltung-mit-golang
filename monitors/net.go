...
func (cpuM *NetMonitor) Check(ctx context.Context) (string , bool) {
	...
	val := fmt.Sprintf("Send: %d KB, Recv: %d KB", netStat[0].BytesSent/1024, netStat[0].BytesRecv/1024) // đổi byte ra kb
